...
const DUMMY_HACKATHONS = [
  {
    ...
    prizes: { first: '15,000', second: '7,000', third: '3,000' },
    maxTeamSize: 4,
    mode: 'Hybrid',
  ...
  },
  {
    ...
    prizes: { first: '10,000', second: '4,000', third: '1,000' },
    maxTeamSize: 5,
    mode: 'In-Person',
  ...
  },
  {
    ...
    prizes: { first: '25,000', second: '5,000' },
    maxTeamSize: 4,
    mode: 'In-Person',
  ...
  },
  {
    ...
    prizes: { first: '12,000', second: '5,000' },
    maxTeamSize: 3,
    mode: 'Hybrid',
  ...
  },
  {
    ...
    endDate: '2024-12-27T17:00:00.000Z',
  ...
  {
    _id: 'dummy7',
    name: 'Cloud Native Expo 2024',
    startDate: '2024-11-15T08:00:00.000Z',
    endDate: '2024-11-17T19:00:00.000Z',
    location: 'Austin, TX',
    status: 'closed',
  ...
  {
    _id: 'dummy9',
    name: 'Data Science Pulse 2025',
    startDate: '2025-02-10T09:00:00.000Z',
    endDate: '2025-02-12T20:00:00.000Z',
    location: 'Remote',
    status: 'upcoming',
    ...
    maxTeamSize: 3,
    mode: 'Virtual',
    website: 'https://data-science-pulse.dev',
  ...
  {
    _id: 'dummy10',
    name: 'HealthTech Hack 2024',
    startDate: '2024-10-15T09:00:00.000Z',
    endDate: '2024-10-17T18:00:00.000Z',
    location: 'Boston, MA',
    status: 'open',
    description: 'Building technology for humanitarian and medical use. Focus on telemedicine, mental health apps, and healthcare accessibility.',
    prizes: { first: '20,000', second: '5,000' },
    maxTeamSize: 4,
    mode: 'Hybrid',
    website: 'https://healthtech-hack.dev',
    requirements: ['Bio-tech interest', 'UI design', 'Backend development'],
    perks: ['Medical Expert Mentors', 'Fast-track to Accelerators', 'Hardware Kits']
  },
  {
    _id: 'dummy11',
    ...
    location: 'Dubai, UAE',
    status: 'upcoming',
    description: 'Design the cities of tomorrow. Focus on IoT, traffic management, and smart infrastructure.',
    prizes: { first: '15,000' },
    maxTeamSize: 4,
    mode: 'In-Person',
    website: 'https://smart-citydubai.dev',
    requirements: ['IoT knowledge', 'System design', 'Urban planning interest'],
    perks: ['Government Partnerships', 'IoT Device Kits', 'Networking']
  },
  {
    _id: 'dummy12',
    ...
    location: 'Remote',
    status: 'closed',
    description: 'Reimagining the learning experience for students around the world.',
    prizes: { first: '10,000' },
    maxTeamSize: 3,
    mode: 'Virtual',
    website: 'https://edutech-innovators.dev',
    requirements: ['Educational passion', 'Mobile/Web skills', 'Gamification ideas'],
    perks: ['LMS Integration Support', 'Education Researcher Mentors']
  }
];
